...
namespace AuroraUI.Demo.Menus
{
    ...
    public static class MenuDefinitions
    {
        ...
        [Export]
        public static MenuItemGroupDefinition FileSaveGroup = new MenuItemGroupDefinition(AuroraUI.Modules.MainMenu.MenuDefinitions.FileMenu, 100);

        [Export]
        public static MenuItemGroupDefinition EditUndoRedoGroup = new MenuItemGroupDefinition(AuroraUI.Modules.MainMenu.MenuDefinitions.EditMenu, 100);
        
        [Export]
        public static MenuItemGroupDefinition EditClipboardGroup = new MenuItemGroupDefinition(AuroraUI.Modules.MainMenu.MenuDefinitions.EditMenu, 200);
        
        [Export]
        public static MenuItemGroupDefinition EditSelectGroup = new MenuItemGroupDefinition(AuroraUI.Modules.MainMenu.MenuDefinitions.EditMenu, 300);
        
        [Export]
        public static MenuItemGroupDefinition EditFindGroup = new MenuItemGroupDefinition(AuroraUI.Modules.MainMenu.MenuDefinitions.EditMenu, 400);
    }
