    ...
    public class DemoBootstrapper : AppBootstrapper
    {
        ...
        private void LoadDemoLanguageResources()
        {
            try
            {
                ...
                // 加载Demo项目的语言资源文件
                var demoResourceUri = new Uri($"avares://AuroraUI.Demo/Resources/Languages/{currentLanguage}.xaml");
            ...
            catch (Exception ex)
            {
                ...
                try
                {
                    var fallbackUri = new Uri("avares://AuroraUI.Demo/Resources/Languages/zh-CN.xaml");
