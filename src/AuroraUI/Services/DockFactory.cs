...
using AuroraUIFramework = AuroraUI.Framework;
...
public class DockFactory : Factory
{
    ...
    public void AddDocument(AuroraUIFramework.Document document)
    {
    ...
    public void AddTool(AuroraUIFramework.Tool tool, DockAlignment alignment = DockAlignment.Left)
    {
    ...
    private IDockable CreateDockableFromDocument(AuroraUIFramework.Document document)
    {
    ...
    private IDockable CreateDockableFromTool(AuroraUIFramework.Tool tool)
    {
    ...
    private AuroraUIFramework.Document CreateWelcomeDocument()
    {
        var welcomePage = new AuroraUIFramework.WelcomePageViewModel
        {
            Id = Guid.NewGuid()
        };
