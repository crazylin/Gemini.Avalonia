...
namespace AuroraUI.Framework
{
    ...
    public class ModuleFilterService : IModuleFilterService
    {
        ...
        {
            // 框架核心组件 - 总是启用
            { "AuroraUI.Framework", "CoreFramework" },
            
            // 核心模块映射（包含子命名空间）
            { "AuroraUI.Modules.ProjectManagement", "ProjectManagementModule" },
            { "AuroraUI.Modules.Output", "OutputModule" },
            { "AuroraUI.Modules.Properties", "PropertiesModule" },
            { "AuroraUI.Modules.Settings", "SettingsModule" },
            { "AuroraUI.Modules.MainMenu", "MainMenuModule" },
            { "AuroraUI.Modules.Theme", "ThemeModule" },
            { "AuroraUI.Modules.ToolBars", "ToolBarsModule" },
            { "AuroraUI.Modules.StatusBar", "StatusBarModule" },
            { "AuroraUI.Modules.UndoRedo", "UndoRedoModule" },
            { "AuroraUI.Modules.WindowManagement", "WindowManagementModule" },
