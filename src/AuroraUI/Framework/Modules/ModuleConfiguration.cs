...
using AuroraUI.Modules.Theme;
using AuroraUI.Modules.WindowManagement;
using AuroraUI.Modules.StatusBar;
using AuroraUI.Modules.Output;
using AuroraUI.Modules.Properties;
using AuroraUI.Modules.ProjectManagement;
using AuroraUI.Modules.Settings;
        ...
        public static List<ModuleMetadata> GetAllModuleConfigurations()
        {
            return new List<ModuleMetadata>
            {
                ...
                new ModuleMetadata
                {
                    ...
                    ModuleType = typeof(AuroraUI.Modules.MainMenu.Module)
                },
                ...
                new ModuleMetadata
                {
                    ...
                    ModuleType = typeof(AuroraUI.Modules.Theme.Module)
                },
                ...
                new ModuleMetadata
                {
                    ...
                    Priority = 100,
                    AllowLazyLoading = true,
                    ModuleType = typeof(AuroraUI.Modules.ProjectManagement.Module),
                ...
                new ModuleMetadata
                {
                    ...
                    Priority = 110,
                    AllowLazyLoading = true,
                    ModuleType = typeof(AuroraUI.Modules.Output.Module)
                },
                ...
                new ModuleMetadata
                {
                    ...
                    Priority = 120,
                    AllowLazyLoading = true,
                    ModuleType = typeof(AuroraUI.Modules.Properties.Module)
                },
                ...
                new ModuleMetadata
                {
                    ...
                    Priority = 130,
                    AllowLazyLoading = true,
                    ModuleType = typeof(AuroraUI.Modules.Settings.Module),
                    Dependencies = new List<string> { "MainMenuModule" }
                },
