...
namespace AuroraUI.Modules.ProjectManagement.Commands
{
    ...
    public class NewProjectCommandDefinition : CommandDefinition
    {
        ...
        public override Uri? IconSource => new Uri("avares://AuroraUI/Assets/Icons/new-project.svg");
    }
    ...
    public class OpenProjectCommandDefinition : CommandDefinition
    {
        ...
        public override Uri? IconSource => new Uri("avares://AuroraUI/Assets/Icons/open-project.svg");
    }
    ...
    public class CloseProjectCommandDefinition : CommandDefinition
    {
        ...
        public override Uri? IconSource => new Uri("avares://AuroraUI/Assets/Icons/close-project.svg");
    }
    ...
    public class RefreshProjectCommandDefinition : CommandDefinition
    {
        ...
        public override Uri? IconSource => new Uri("avares://AuroraUI/Assets/Icons/refresh.svg");
    }
    ...
    public class AddFileCommandDefinition : CommandDefinition
    {
        ...
        public override Uri? IconSource => new Uri("avares://AuroraUI/Assets/Icons/add-file.svg");
    }
    ...
    public class AddFolderCommandDefinition : CommandDefinition
    {
        ...
        public override Uri? IconSource => new Uri("avares://AuroraUI/Assets/Icons/add-folder.svg");
    }
    ...
    public class DeleteItemCommandDefinition : CommandDefinition
    {
        ...
        public override Uri? IconSource => new Uri("avares://AuroraUI/Assets/Icons/delete.svg");
    }
}