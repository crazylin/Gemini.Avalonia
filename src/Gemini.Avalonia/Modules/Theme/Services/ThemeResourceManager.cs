...
namespace Gemini.Avalonia.Modules.Theme.Services
{
    ...
    public class ThemeResourceManager : IThemeResourceManager
    {
        ...
        private Uri? GetThemeResourceUri(ThemeType themeType)
        {
            ...
            {
                ThemeType.Light => new Uri("avares://Gemini.Avalonia/Modules/Theme/Resources/LightTheme.axaml"),
                ThemeType.Dark => new Uri("avares://Gemini.Avalonia/Modules/Theme/Resources/DarkTheme.axaml"),
                _ => null
            };
        }
    }
