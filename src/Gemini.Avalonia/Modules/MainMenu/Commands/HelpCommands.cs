...
namespace Gemini.Avalonia.Modules.MainMenu.Commands
{
    /// <summary>
    /// 关于应用程序命令定义
    /// </summary>
    ...
    public class AboutApplicationCommandDefinition : CommandDefinition
    {
        ...
        public override Uri IconSource => new Uri("avares://Gemini.Avalonia/Assets/Icons/about.svg");
    }
    ...
    public class ModuleListCommandDefinition : CommandDefinition
    {
        ...
        public override Uri IconSource => new Uri("avares://Gemini.Avalonia/Assets/Icons/modules.svg");
    }
...
public class AboutDialog : Window
{
    ...
    private void InitializeComponent()
    {
        ...
        {
            Text = "Gemini.Avalonia Framework",
            FontSize = 20,
